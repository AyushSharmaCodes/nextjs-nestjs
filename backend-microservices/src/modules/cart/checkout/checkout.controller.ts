...
export class CheckoutController {
  ...
  @Post('initiate') async initiate(@Body() body: { cartId: string }, @Headers('x-user-id') userId: string) { return ApiResponse.success(await this.service.initiateCheckout(body.cartId, userId, body)); }
